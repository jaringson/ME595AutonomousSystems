...
class plotData:
    ...
    def __init__(self):
        ...
        self.handle = []
        self.handle.append(myPlot(self.ax[0], ylabel='x (m)', title='States', legend=['Truth', 'Estimate']))
        ...
        self.handle2 = []
        self.handle2.append(myPlot(self.ax2[0], ylabel='X Error', title='Error', legend=['Error', '2 Sig', '-2 Sig']))
