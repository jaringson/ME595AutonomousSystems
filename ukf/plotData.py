...
class plotData:
    ...
    def update(self, t, states, mu, sig):
        ...
        self.handle2[0].update(self.time_history, [self.error_x, self.sig_x])
        self.handle2[1].update(self.time_history, [self.error_y, self.sig_y])
        self.handle2[2].update(self.time_history, [self.error_theta, self.sig_theta])
